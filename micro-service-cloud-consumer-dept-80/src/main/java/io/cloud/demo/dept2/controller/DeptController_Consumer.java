package io.cloud.demo.dept2.controller;
...
public class DeptController_Consumer {
    ...
    public Dept get(@PathVariable("id") Integer id) {
        return restTemplate.getForObject(REST_URL_PROVIDER_PREFIX + "/cloud/demo/dept/get/" + id, Dept.class);
    }
    //获取部门列表
    @RequestMapping(value = "/list")
    public List<Dept> list() {
        return restTemplate.getForObject(REST_URL_PROVIDER_PREFIX + "/cloud/demo/dept/list", List.class);
    }
}
